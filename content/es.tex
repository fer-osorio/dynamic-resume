...
\newcommand{\secSecPortfolio}{Portafolio de Seguridad}
...
\newcommand{\subSecPortfolio}{Sitio Web de Portafolio de Seguridad [HTML, CSS, JavaScript, Criptografía Web]}
...
\newcommand{\dateSecPortfolio}{Julio 2025 -- Presente (Mantenimiento activo)}
...
% =============================================================================
\newcommand{\secportfolioPlatformDesc}{\textbf{Plataforma:} Sitio web público que muestra investigación criptográfica, herramientas interactivas.}

\newcommand{\secportfolioDemoIntro}{\textbf{Demostraciones Criptográficas Interactivas:}}
